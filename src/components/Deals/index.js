          ...
          <div className="row card-row">
            <div className="col-sm-3">
              <div className="card text-center">
                <img
                  ...
                  src={process.env.PUBLIC_URL + "images/destination-2.jpg"}
                  alt="Hot deals"
                />
            ...
            <div className="col-sm-3">
              <div className="card text-center">
                <img
                  className="card-img-top"
                  src={process.env.PUBLIC_URL + "images/destination-5.jpg"}
                  alt="Hot deals"
                />
                <div className="card-body">
            ...
            <div className="col-sm-3">
              <div className="card text-center">
                <img
                  className="card-img-top"
                  src={process.env.PUBLIC_URL + "images/destination-6.jpg"}
                  alt="Hot deals"
                />
                <div className="card-body">
            ...
            <div className="col-sm-3">
              <div className="card text-center">
                <img
                  className="card-img-top"
                  src={process.env.PUBLIC_URL + "images/destination-4.jpg"}
                  alt="Hot deals"
                />
                <div className="card-body">
